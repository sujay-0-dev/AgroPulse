...
import CropFinderPage from './CropFinderPage';
...
const AppLayout = ({ session }) => {
  ...
  switch (activeTab) {
      case 'cropFinder':
          ActiveComponent = <CropFinderPage />;
          break;
      case 'advisory':
          ActiveComponent = <AdvisoryPage />;
          break;
      case 'dashboard':
      default:
    ...
    <div className="min-h-screen font-sans bg-gray-100">
      ...
      <nav className="fixed bottom-0 left-0 w-full bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)] p-2 rounded-t-2xl z-40">
         <div className="flex items-center justify-around">
          ...
          <NavButton icon="fa-solid fa-magnifying-glass" label="Crop Finder" isActive={activeTab === 'cropFinder'} onClick={() => setActiveTab('cropFinder')} />
          <NavButton icon="fa-solid fa-leaf" label="Advisory" isActive={activeTab === 'advisory'} onClick={() => setActiveTab('advisory')} />
